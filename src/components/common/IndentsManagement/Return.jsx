...
const Return = () => {
  ...
  const handleSubmit = async () => {
    console.log(date, bmcCc, materialCode, materialName, stockHand,returnQuantity, reason);
    try {
  ...
  return (
    <Layout>
      <Flex justify="center" align="center" height="75vh" bg="white.50">
        <Box p={8} maxWidth="800px" borderWidth={1} borderRadius={8} boxShadow="lg" bg="white">
          <VStack spacing={4}>
            <Heading as="h3" size="lg" textAlign="center">Return</Heading>
            ...
            <SimpleGrid columns={3} spacing={4} width="full">
              ...
              <FormControl id="requireQuantity">
                ...
                <Input type="number" placeholder="" value={returnQuantity} onChange={(e) => setReturnQuantity(e.target.value)} fontWeight="bold" />
              </FormControl>
